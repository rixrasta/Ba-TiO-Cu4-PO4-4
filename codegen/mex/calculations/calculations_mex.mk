START_DIR = C:\Users\Riho\Desktop\PPEMAT~1\BA(TIO~1\matlab\average\katse14\NEWFOL~1

MATLAB_ROOT = D:\PROGRA~1\MATLAB\R2016a
MAKEFILE = calculations_mex.mk

include calculations_mex.mki
...
SRC_FILES =  \
	...
	diag.c \
	mldivide.c \
	_coder_calculations_info.c \
	_coder_calculations_api.c \
	_coder_calculations_mex.c

MEX_FILE_NAME_WO_EXT = calculations_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\calculations"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\calculations/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
