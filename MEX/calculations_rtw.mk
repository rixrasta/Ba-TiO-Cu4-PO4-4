...
## Generated on : Wed Apr 04 12:43:36 2018
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
SRCS = $(START_DIR)/calculations_rtwutil.c $(START_DIR)/calculations_initialize.c $(START_DIR)/calculations_terminate.c $(START_DIR)/calculations.c $(START_DIR)/poore.c $(START_DIR)/mrdivide.c $(START_DIR)/isfinite.c $(START_DIR)/eig.c $(START_DIR)/xzggev.c $(START_DIR)/sqrt.c $(START_DIR)/xzlangeM.c $(START_DIR)/xzlartg.c $(START_DIR)/xzhgeqz.c $(START_DIR)/xzlanhs.c $(START_DIR)/mod.c $(START_DIR)/xztgevc.c $(START_DIR)/diag.c $(START_DIR)/rt_nonfinite.c $(START_DIR)/rtGetNaN.c $(START_DIR)/rtGetInf.c
